class ConfiguracionNomina():
	def __init__(self, nombre_archivo_errores, nombre_archivo_registro, nombre_archivo_liquidacion, numero_minimo_lineas, smlv, auxilio_transporte, tope_auxilio_transporte, topo_fondo_solidaridad, porcentaje_fondo_solidaridad, porcentaje_arl):
		...
		self.topo_fondo_solidaridad = topo_fondo_solidaridad
