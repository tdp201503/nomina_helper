...
def main():
    ...
    configuracion_por_defecto = ConfiguracionNomina(
        ...
        "liquidacion.txt",  # Nombre archivo que contendra la liquidacion de la nomina
        ...
        0.00522
        # Porcentaje Administracion de Riesgos Laborales. Modifcar porcentaje segun el tipo de riesgo definido en: https://www.positiva.gov.co/ARL/Paginas/default.aspx
    )
